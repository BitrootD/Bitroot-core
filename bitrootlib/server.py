...
from bitrootlib.lib import api, config, util, exceptions, blocks, check, backend, database, transaction, script
...
def initialise_config(database_file=None, log_file=None, api_log_file=None,
    ...
    # Log directory
    log_dir = appdirs.user_log_dir(appauthor=config.BITROOT_NAME, appname=config.APP_NAME)
    ...
    logger.info('Running v{} of bitroot-lib.'.format(config.VERSION_STRING))
