...
from bitrootlib.test.fixtures.params import DEFAULT_PARAMS as DP, ADDR
from bitrootlib.test.util_test import CURR_DIR
from bitrootlib.test import util_test

from bitrootlib.lib import (blocks, transaction, api, backend)
...
def test_estimate_fee_per_kb(fee_per_kb, fee_per_kb_used, server_db, monkeypatch):
    ...
    monkeypatch.setattr('bitrootlib.lib.backend.fee_per_kb', _fee_per_kb)
