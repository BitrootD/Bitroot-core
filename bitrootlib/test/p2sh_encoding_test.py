...
from bitrootlib.test.fixtures.params import DP, ADDR, P2SH_ADDR
...
from bitrootlib.lib import api
from bitrootlib.lib import backend
from bitrootlib.lib import blocks
from bitrootlib.lib import exceptions
from bitrootlib.lib.transaction_helper import serializer
from bitrootlib.lib.transaction_helper import p2sh_encoding
...
def test_p2sh_encoding(server_db):
    ...
    with util_test.ConfigContext(DISABLE_ARC4_MOCKING=True, OLD_STYLE_API=True), util_test.MockProtocolChangesContext(enhanced_sends=True, p2sh_encoding=True):
        ...
        assert parsed_data == binascii.unhexlify("00000002" "0000000000000001" "0000000000000064" "6f8d6ae8a3b381663118b4e1eff4cfc7d0954dd6ec")  # ID=enhanced_send(0x02) ASSET.BITROOT(0x01) VALUE=100(0x64) destination_pubkey(0x6f8d...d6ec)
