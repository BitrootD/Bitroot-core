...
```
mv bitrootlib/test/fixtures/scenarios/unittest_fixture.new.json bitrootlib/test/fixtures/scenarios/unittest_fixture.json
mv bitrootlib/test/fixtures/scenarios/unittest_fixture.new.sql bitrootlib/test/fixtures/scenarios/unittest_fixture.sql
mv bitrootlib/test/fixtures/scenarios/unittest_fixture.new.log bitrootlib/test/fixtures/scenarios/unittest_fixture.log
```
...
UNITTEST_FIXTURE = [
    ...
    ['order', (ADDR[0], .BITROOT', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'DIVISIBLE', DP['quantity']), {'encoding': 'multisig'}, None],
    ['send', (ADDR[0], ADDR[1], .BITROOT', DP['quantity']), {'encoding': 'multisig'}, None],
    ['order', (ADDR[0], .BITROOT', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['order', (ADDR[0], .BITROOT', DP['quantity'], 'BTC', round(DP['quantity'] / 100), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'BTC', round(DP['quantity'] / 150), .BITROOT', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ['send', (ADDR[0], MULTISIGADDR[0], .BITROOT', DP['quantity'] * 3), {'encoding': 'multisig'}, None],
    ...
    ['dispenser', (ADDR[5], .BITROOT', 100, 100, 100, 0), {'encoding': 'opreturn'}],
    ...
    ['send', (ADDR[0], ADDR[1], .BITROOT', DP['quantity'], 'hello', False, True), {'encoding': 'opreturn'}, {'enhanced_sends': True}],
    ['send', (ADDR[1], ADDR[0], .BITROOT', DP['quantity'], 'fade0001', True, True), {'encoding': 'opreturn'}, {'enhanced_sends': True}],
    ...
    ['order', (ADDR[0], .BITROOT', DP['quantity'], 'BTC', round(DP['quantity'] / 125), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[1], 'BTC', round(DP['quantity'] / 125), .BITROOT', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ...
    ['send', (ADDR[2], ADDR[3], .BITROOT', 92945878046), {'encoding': 'multisig'}, None],
...
def generate_standard_scenario(address1, address2, order_matches):
    ...
    return [
        ...
        ['send', (address1, address2, .BITROOT', DP['small']), {'encoding': 'multisig'}, None],
        ['order', (address1, 'BTC', DP['small'], .BITROOT', DP['small'] * 2, DP['expiration'], 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
        ['order', (address1, .BITROOT', round(DP['small'] * 2.1), 'BTC', DP['small'], DP['expiration'], DP['fee_required']), {'encoding': 'multisig'}],
        ...
        ['dividend', (address1, 600, 'BBBB', .BITROOT'), {'encoding': 'multisig'}],
        ['dividend', (address1, 800, 'BBBC', .BITROOT'), {'encoding': 'multisig'}],
        ...
        ['order', (address1, 'BBBB', DP['small'], .BITROOT', DP['small'], DP['expiration'], 0), {'encoding': 'multisig'}],
