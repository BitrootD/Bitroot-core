...
BTC_NAME = 'Bitcoin'
BITROOT_NAME = 'Bitroot'
APP_NAME =.BITROOT_NAME.lower()
...
UNSPENDABLE_REGTEST = 'mvBitrootXXXXXXXXXXXXXXW24Hef'
UNSPENDABLE_TESTNET = 'mvBitrootXXXXXXXXXXXXXXW24Hef'
UNSPENDABLE_MAINNET = '1BitrootXXXXXXXXXXXXXXXXXXXXUWLpVr'
